...
class EpisodesAdapter(
    private val episodesData: List<EpisodeResponse>,
    private val onItemSelected: OnItemSelected<EpisodeResponse>
) :
    ...
    override fun onBindViewHolder(holder: EpisodesViewHolder, position: Int) =
        holder.bindEpisode(episodesData[position], onItemSelected)
